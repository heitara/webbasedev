...
import net.jforum.view.forum.PostActionNew;
...
public class POPPostAction
{
	...
	/**
	 * Calls {@link PostActionNew#insertSave()}
	...
	private void insertMessage(POPMessage m, User user)
	{
		...
		PostActionNew postAction = new PostActionNew(JForumExecutionContext.getRequest(), new SimpleHash());
