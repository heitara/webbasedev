...
public class BiglobePointChargeControlAction extends ModelDrivenActionSupport<MemSettlementHist> {
	...
	public void chargeReceive() {
		...
		if (isCallFromProvider()) {
			...
			MemSettlementTrns settlementTrns = pointChargeBusinessLogic.getSettlementTrnsByKey(getModel().getSettlementTrnsNum());
	...
	public void setPointChargeBusinessLogic(IPointChargeBusinessLogic pointChargeBusinessLogic) {
