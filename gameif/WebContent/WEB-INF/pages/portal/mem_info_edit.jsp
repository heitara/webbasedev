...
<dl class="light_box tspace_n">
	...
	<dd>
		<s:form action="updateMemberInfo" cssClass="entry">
			<dl>
				<dt><label for="giid">アカウントID：</label></dt>
				<dd><span class="item"><%=com.gameif.common.util.ContextUtil.getAccountId()%></span></dd>
				<dt></dt>
				<dd>&nbsp;</dd>

				<dt>
					<span class="required">*</span><label for="updateMemberInfo_nickName">ニックネーム：</label>
				</dt>
				<dd>
				...
				<dt>
					<span class="required">*</span><label for="updateMemberInfo_mailPc">メールアドレス：</label>
				</dt>
				<dd>
				...
				<dt><label for="updateMemberInfo_kanjiFname">氏名：</label></dt>
				<dd>
				...
				<dt><label for="updateMemberInfo_kanaFname">フリカナ：</label></dt>
				<dd>
				...
				<dt><span class="required">*</span><label for="updateMemberInfo_sexCd">性別：</label></dt>
				<dd>
					<s:radio name="model.sexCd" list="portalProperties.sexListMap" title="性別" onblur="validate(this, 'REQ');"/>
					<span id="error_sexCd" class="input_error"><s:fielderror><s:param>sexCd</s:param></s:fielderror></span>
				</dd>
				
				<dt><span class="required">*</span><label for="updateMemberInfo_birthY">生年月日：</label></dt>
				<dd>
				...
				<dt><span class="required">*</span><label for="updateMemberInfo_occupCd">職業：</label></dt>
				<dd>
				...
				<dt><span class="required">*</span><label for="updateMemberInfo_divisCd">都道府県：</label></dt>
				<dd>
				...
				<dt><label for="updateMemberInfo_cityName">市区町村：</label></dt>
				<dd>
				...
				<dt><label for="updateMemberInfo_buildingName">番地建物：</label></dt>
				<dd>
				...
				<dt><label for="updateMemberInfo_telNum">電話番号：</label></dt>
				<dd>
				...
				<dd>
					...
					<label for="updateMemberInfo_mailmagReqCd">メルマガを受信する。</label>
				</dd>
