...
<head>
	...
	<script src="js/portal/bindMaster.js" type="text/javascript"></script>	<script type="text/javascript">
		window.onload = function(){   
			...
			var pointId = $("#pointId");
			bindServerAndPointForMixi(titleId, serverId, pointId);
        };
	</script>
</head>
...
<dl class="light_box tspace_n">
	...
	<dd>
		<s:form name="frm_nosubmit_point_select" action="chargeSettleSelectInitForMixi" method="post" cssClass="entry">
			...
			<table width="95%" align="center">
				...
				<tr>
					...
					<td>
						<s:select name="titleId" id="titleId" cssClass="big" list="masterInfoBusinessLogic.validTitleList" listKey="titleId" listValue="titleName" title="ゲーム"  onchange="bindServerAndPointForMixi(this, serverId, pointId);" onblur="validate(this,'REQ');" />
