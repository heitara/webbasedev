		...
		<s:form name="frm_invite_hist" method="post" cssClass="entry">
			...
			<table class="friendhist tspace_y" align="center">
				...
				<tr id="listTitle">
					...
					<th class="status">
						<s:select name="inviteStatusSelect" list="paymentProperties.inviteStatusList" cssStyle="width:100px;" headerKey="9999" headerValue="全て" onclick="selectInvitedHist(this, 'inviteStatus_')"/>
					</th>
				...
				<s:iterator value="listInviteHist" id="inviteId" status="st">
					<tr id="inviteStatus_<s:property value='inviteStatus'/>" <s:if test="#st.odd">class="odd" </s:if> >
						...
						<td class="status">
							<s:property value="paymentProperties.inviteStatusList[inviteStatus]"/>
						</td>
