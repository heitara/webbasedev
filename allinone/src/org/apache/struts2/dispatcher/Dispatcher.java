...
public class Dispatcher {
    ...
    //▼2009-11-16 李 追加：決済ＩＦ文字コード設定
    /**
     * Store state of StrutsConstants.STRUTS_I18N_CHARGE_IF_ENCODING setting.
     */
    private static String chargeIFEncoding;
    private static String chargeIFPage;
    //▲2009-11-16 李 追加：決済ＩＦ文字コード設定
    ...
    // ▼ 2009-11-16 李 追加：決済ＩＦ文字コード追加
    @Inject("struts.i18n.charge.if.encoding")
    public static void setChargeIFEncoding(String chargeIFEncoding) {
		Dispatcher.chargeIFEncoding = chargeIFEncoding;
	}
    @Inject("struts.i18n.charge.if.page")
	public static void setChargeIFPage(String chargeIFPage) {
		Dispatcher.chargeIFPage = chargeIFPage;
	}
    // ▲ 2009-11-16 李 追加：決済ＩＦ文字コード追加
...
Caused by: com.opensymphony.xwork2.inject.ContainerImpl$MissingDependencyException: No mapping found for dependency [type=org.apache.struts2.dispatcher.mapper.ActionMapper, name='default'] in public static void org.apache.struts2.dispatcher.FilterDispatcher.setActionMapper(org.apache.struts2.dispatcher.mapper.ActionMapper).
   ...
   */
    ...
    public void prepare(HttpServletRequest request, HttpServletResponse response) {
        ...
        // ▼ 2009-11-16 李 追加：決済ＩＦ文字コード追加        
        String[] ifPages = chargeIFPage.split(",");
        
        if (ifPages != null) {

            for (String ifPage : ifPages) {

            	if (request.getRequestURI().indexOf(ifPage.trim()) >= 0) {
            		
            		encoding = chargeIFEncoding;
            	} 
            }
        }
        // ▲ 2009-11-16 李 追加：決済ＩＦ文字コード追加
