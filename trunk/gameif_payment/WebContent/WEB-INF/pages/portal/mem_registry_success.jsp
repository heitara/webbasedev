		...
		<dl class="finish">
			...
			<dd>
				<div class="msg">
					...
					ご登録されたメールアドレスへご本人様確認のメールをお送りしましたので、そちらのメールを確認して、アカウントを有効化してください。<br/>
					※お登録のメールアドレス：　<span style="color:#900"><s:property value="mailPc" escape="true"/></span> &nbsp; （確認してください。）
					<!-- 
					<span style="color:#900;font-weight:bold;">フリーメールのご利用の場合</span>は、自動的に迷惑メールとして振り分けられることもございますので、もしメールが届かなかったら、<br/>
					迷惑メールフォルダのほうもご確認いただけますようお願いします。
					 -->
