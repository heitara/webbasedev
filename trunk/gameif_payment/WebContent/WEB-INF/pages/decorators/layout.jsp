...
<%@page import="com.gameif.payment.businesslogic.ITitlePlayBusinessLogic"%>
<%@page import="com.gameif.payment.util.ContextUtil"%>
<%@page import="edu.yale.its.tp.cas.client.filter.CASFilter"%>
<%@page import="com.gameif.payment.entity.MyTitle"%>
<%@page import="com.gameif.payment.constants.PortalConstants"%>
<%@page import="com.gameif.payment.entity.MyServer"%>
<%@page import="com.gameif.payment.businesslogic.IBetaTesterBusinessLogic"%>
<%
	/* =======================================　頁内共通変数設定  =======================================*/
