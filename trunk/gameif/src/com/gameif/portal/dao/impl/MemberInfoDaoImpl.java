...
public class MemberInfoDaoImpl extends AbstractBaseDao<MemberInfo, MemberInfo> implements IMemberInfoDao {
	...
	public int selectCountByIPAndTime(String clientIP, Integer checkTime) {
		...
		return (Integer) (getSqlMapClientTemplate().queryForObject(namespace + ".selectCountByIPAndTime", cond));
	}
	...
	public int selectCountByMemId(String memId, Long memNum) {
		...
		return (Integer) (getSqlMapClientTemplate().queryForObject(namespace + ".selectCountByMemIdForOther", cond));
	}
	...
	public int selectCountByNickName(String nickName, Long memNum) {
		...
		return (Integer) (getSqlMapClientTemplate().queryForObject(namespace + ".selectCountByNickNameForOther", cond));
	}
	...
	public int selectCountByMailPc(String mailPc, Long memNum) {
		...
		return (Integer) (getSqlMapClientTemplate().queryForObject(namespace + ".selectCountByMailPcForOther", cond));
	}
}
