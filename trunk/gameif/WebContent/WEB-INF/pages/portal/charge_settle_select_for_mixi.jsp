	...
	<dd>
		<s:form name="frm_nosubmit_settle_select" method="post" cssClass="entry">
			...
			<div class="submit">
				...
				<s:token />
				<s:submit value="次へ" action="chargeSaveSettleTrnsForMixi" cssClass="submit" onclick="return checkCount();"/>
				<s:submit value="戻る" action="chargePointSelectForMixi" cssClass="submit" />
			</div>
		</s:form>
	</dd>
</dl>
