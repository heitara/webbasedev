...
<dl class="light_box tspace_n">
	...
	<dd>
		<s:form name="frm_template_add" action="updateInquiryTemplate" cssClass="entry">
			<s:hidden name="inquirySendmailId"></s:hidden>
			<table>
				<tr>
					<th></th>
					<td>
				...
				<tr>
					...
					<td>
						<s:textfield name="model.inquirySendmailName" cssStyle="width:400px;" maxlength="25" title="テンプレート名" onblur="validate(this, 'REQ');"/>
				...
				<tr>
					...
					<td>
						<s:textarea name="model.inquirySendmailContents" rows="10" cssClass="big ime_mode_n" cssStyle="width:580px;" title="返信内容" onblur="validate(this, 'REQ,LEN_0_1000');" />
