...
<dl class="light_box tspace_n">
	...
	<dd>
		<s:form action="createAuthority" cssClass="entry">
			<table>
				<tr>
					<th></th>
					<td>
				...
				<tr>
					...
					<td>
						<s:textfield name="authority.authorityCode" maxlength="20" cssClass="ime_mode_n" title="権限コード" onblur="validate(this, 'REQ,ALN,LEN_4_20,EXI');"/>
						<span class="explain">※ 4～20桁の半角英数字で入力してください。</span>
						<span id="error_authority.authorityCode" class="input_error"><s:fielderror><s:param>authority.authorityCode</s:param></s:fielderror></span>
					</td>
				</tr>
				<tr>
