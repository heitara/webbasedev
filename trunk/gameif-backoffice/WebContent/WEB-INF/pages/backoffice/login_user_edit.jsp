	...
	<dl class="light_box tspace_n">
		...
		<dd>
			<s:form name="frm_login_user_input" method="post" cssClass="entry">
				...
				<table>
					<tr>
						<th><span class="required">*</span><label for="updateLoginUser_userId">ユーザＩＤ：</label></th>
						<td>
							<span class="explain"><s:property value="userId"/></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th><span class="required">*</span><label for="updateLoginUser_password">パスワード：</label></th>
						<td>
					...
					<tr>
						<th><span class="required">*</span><label for="updateLoginUser_confirmPassword">パスワード再入力：</label></th>
						<td>
				...
				<div class="submit">
					<s:token />
					<s:submit value="保存" action="replyInquriy" />
